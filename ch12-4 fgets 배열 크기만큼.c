...
{
    printf("fgets(char[], sizeof char, stdin): \n");
    printf("stdin: 표준 입력 버퍼 \n");
    printf("char[size - 1]에는 항상 null 문자열 \\0 저장된다. \n");
    printf("fgets에 입력된 문자열은 Enter 시 버퍼 저장 \n");
    printf("입력된 문자열이 size - 1보다 크면 size 만큼만 저장 \n");
